...
#define STRING_CONFIG_H_AUTHOR "(PhobosX, SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender3v2.1"
...
// #define Z_MIN_PROBE_PIN PC14 // 46 pi  is bltouch plug?
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, -10, 0 } // for microswiss dd and hero me gen5
...
// microswiss dd and hero me gen 5, two blower 5015
#define X_MIN_POS -5
#define Y_MIN_POS -10
#define Z_MIN_POS 0
#define X_MAX_POS (X_BED_SIZE + X_MIN_POS + 28)
